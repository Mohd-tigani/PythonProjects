...
def updateHand(hand, word):
    ...
    new_hand = hand.copy()
    for letter in word:
        new_hand[letter] = new_hand.get( letter, 1) - 1
    return new_hand
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        if "." in word:
            ...
            break
        if word in wordList and isValidWord(word,hand,wordList)==True:
            score+=getWordScore(word,n)
            print(word+" earned",getWordScore(word,n),"Total: ",score,"points")
